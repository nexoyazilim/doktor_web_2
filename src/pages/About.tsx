        ...
        <section className="mb-12 sm:mb-16 lg:mb-20">
          <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center">
            <div className="relative order-2 lg:order-1">
              ...
              <div className="absolute -bottom-3 sm:-bottom-6 -right-3 sm:-right-6 bg-[#2E8B57] text-white p-4 sm:p-6 rounded-2xl shadow-lg">
                <div className="text-center">
                  ...
                  <div className="text-xs sm:text-sm">{t('about.experience')}</div>
                </div>
              </div>
            </div>
            ...
            <div className="order-1 lg:order-2">
              ...
              <p className="text-lg sm:text-xl text-[#2E8B57] font-semibold mb-4 sm:mb-6">{t('about.specialty')}</p>
              ...
              <div className="grid grid-cols-2 gap-4 sm:gap-6 mb-6 sm:mb-8">
                <div className="flex items-center gap-2 sm:gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-xs sm:text-sm text-gray-600">{t('about.happyPatients')}</div>
                  </div>
                </div>
                <div className="flex items-center gap-2 sm:gap-3">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 bg-[#2E8B57]/10 rounded-lg flex items-center justify-center">
                  ...
                  <div>
                    ...
                    <div className="text-xs sm:text-sm text-gray-600">{t('about.certificates')}</div>
                  </div>
                </div>
              </div>
              <Link
...
{t('common.appointment')}
        ...
        >
          ...
          <div className="relative z-10">
            <div className="text-center mb-16">
              <h2 className="text-4xl font-bold text-gray-900 mb-4">{t('about.statsTitle')}</h2>
              <p className="text-xl text-gray-600">{t('about.statsSubtitle')}</p>
            </div>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[
              { number: "500+", labelKey: "about.successfulOperations", icon: Award },
              { number: "10+", labelKey: "about.yearsExperience", icon: Clock },
              { number: "15+", labelKey: "about.certificates", icon: GraduationCap },
              { number: "100%", labelKey: "about.patientSatisfaction", icon: Users }
            ].map((stat, index) => (
        ...
        <section className="mb-20">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">{t('about.educationTitle')}</h2>
            <p className="text-xl text-gray-600">{t('about.educationSubtitle')}</p>
          </div>
        ...
        <section className="py-20 bg-gradient-to-br from-[#2E8B57] to-[#32CD32] rounded-3xl text-white">
          <div className="grid lg:grid-cols-2 gap-16">
            <div>
              <h2 className="text-4xl font-bold mb-8">{t('about.professionalExperience')}</h2>
              <div className="space-y-8">
                <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold mb-2">{t('about.expertSurgeon')}</h3>
                    <p className="text-gray-200 mb-1">{t('about.privatePractice')}</p>
                    <p className="text-gray-300 text-sm">2019 - {t('about.present')}</p>
                  </div>
                </div>
                <div className="flex gap-4">
                  <div className="w-12 h-12 bg-white/20 rounded-lg flex items-center justify-center flex-shrink-0">
                  ...
                  <div>
                    <h3 className="text-xl font-bold mb-2">{t('about.clinicalPartner')}</h3>
                    <p className="text-gray-200 mb-1">{t('about.americanHospital')}</p>
            ...
            <div>
              <h2 className="text-4xl font-bold mb-8">{t('about.specializationsTitle')}</h2>
              <div className="space-y-4">
                {[
                  t('about.specialization1'),
                  t('about.specialization2'),
                  t('about.specialization3'),
                  t('about.specialization4'),
                  t('about.specialization5'),
                  t('about.specialization6'),
                  t('about.specialization7')
                ].map((specialty, index) => (
        ...
        <section className="py-16 bg-gray-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-4">{t('about.certificatesTitle')}</h2>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg">
                <h3 className="text-2xl font-bold text-gray-900 mb-6 flex items-center gap-3">
                  ...
                  {t('about.certificationsEarned')}
                </h3>
                <div className="space-y-4">
                  <div className="flex items-start gap-4">
                    <div className="w-3 h-3 bg-[#2E8B57] rounded-full mt-2 flex-shrink-0"></div>
                    <div>
                      <h4 className="font-semibold text-gray-900">{t('about.certTurkey')}</h4>
                      <p className="text-gray-600 text-sm">{t('about.activeMember')}</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    <div className="w-3 h-3 bg-[#2E8B57] rounded-full mt-2 flex-shrink-0"></div>
                    <div>
                      <h4 className="font-semibold text-gray-900">{t('about.certInternational')}</h4>
                      <p className="text-gray-600 text-sm">{t('about.member')}</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    <div className="w-3 h-3 bg-[#2E8B57] rounded-full mt-2 flex-shrink-0"></div>
                    <div>
                      <h4 className="font-semibold text-gray-900">{t('about.certRhinoplasty')}</h4>
                      <p className="text-gray-600 text-sm">{t('about.certRhinoplastySource')}</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    <div className="w-3 h-3 bg-[#2E8B57] rounded-full mt-2 flex-shrink-0"></div>
                    <div>
                      <h4 className="font-semibold text-gray-900">{t('about.certBreast')}</h4>
                      <p className="text-gray-600 text-sm">{t('about.certBreastSource')}</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    <div className="w-3 h-3 bg-[#2E8B57] rounded-full mt-2 flex-shrink-0"></div>
                    <div>
                      <h4 className="font-semibold text-gray-900">{t('about.certHair')}</h4>
                      <p className="text-gray-600 text-sm">{t('about.certHairSource')}</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            {/* Kariyer Timeline */}
            <div className="mt-16">
              <h3 className="text-3xl font-bold text-gray-900 text-center mb-12">{t('about.careerHistory')}</h3>
                ...
                <div className="space-y-8">
                  <div className="flex items-center">
                    <div className="w-1/2 pr-8 text-right">
                      <div className="bg-white p-6 rounded-lg shadow-lg">
                        <h4 className="text-lg font-semibold text-gray-900">{t('about.chiefPhysician')}</h4>
                        <p className="text-gray-600">{t('about.aestheticSurgeryClinic')}</p>
                        <p className="text-sm text-gray-500">2020 - {t('about.continuing')}</p>
                      </div>
                    </div>
                  ...
                  <div className="flex items-center">
                    ...
                    <div className="w-1/2 pl-8">
                      <div className="bg-white p-6 rounded-lg shadow-lg">
                        <h4 className="text-lg font-semibold text-gray-900">{t('about.clinicalPartner')}</h4>
                        <p className="text-gray-600">{t('about.americanHospital')}</p>
                  ...
                  <div className="flex items-center">
                    <div className="w-1/2 pr-8 text-right">
                      <div className="bg-white p-6 rounded-lg shadow-lg">
                        <h4 className="text-lg font-semibold text-gray-900">{t('about.specialistDoctor')}</h4>
                        <p className="text-gray-600">{t('about.certBreastSource')}</p>
